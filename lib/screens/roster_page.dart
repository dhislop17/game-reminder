...
class RosterPage extends StatelessWidget {
  Widget _playerHeader(
      String pType, Color currColor, Team currTeam, BuildContext context) {
    return StickyHeader(
        header: Column(
          children: <Widget>[
            Container(
        ...
        content: Column(
            children: (pType != 'Goalies') 
                        ...
                        .map((p) => Container(child: _playerRow(p, context)))
                        .toList()
  ...
  Widget _playerRow(Player p, BuildContext context) {
    return InkWell(
        onTap: () {},
        child: Container(
          height: 40,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ListView(children: [
          _playerHeader('Skaters', teamCol, viewTeam, context),
          _playerHeader('Goalies', teamCol, viewTeam, context),
        ]));
  }
}
